...
Il existe plusieurs manière d'exécuter du code Python.
Le site : **[replt.it](https://repl.it/repls/GoodnaturedGraveTurtle)** est à mon goût très bien pour commencer.

N'hésitez pas à naviguer à travers le Wiki dans lequel vous trouverez des notions mieux expliquées que dans le workshop suivant.
Vous trouverez aussi de nombreux tutoriels et documentations accessible en lige gratuitement :
